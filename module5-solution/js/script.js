...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(homeHtmlUrl, function (homeHtml) {
      ...
      // Pay attention to what type of data that function returns vs what the chosenCategoryShortName letiable's name implies it expects.
      ...
      //
       let homeHtmlToInsertIntoMainPage = insertProperty(homeHtml,'randomCategoryShortName',"'"+chosenCategoryShortName.short_name+"'");
