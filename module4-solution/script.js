...
// and then output either Hello 'Name' or GoodBye 'Name' to the console.
// The program should say "Hello" to any name except names that start with a "J"
// or "j", otherwise, the program should say "GoodBye". So, the final output
...
for (let i=0; i<names.length; i++) {
  ...
  // Look up these methods on Mozilla Developer Network website if needed.
